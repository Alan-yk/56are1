	        ...
	        <div class="container-fluid">
	            ...
	            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	                <ul class="nav navbar-nav">
	                    <li class="active"><a href="#"><?php echo (L("URL_INDEX")); ?></a></li>
	                    <li><a href="#"><?php echo (L("URL_FORUM")); ?></a></li>
	                    <li class="dropdown">
	                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo (L("URL_NATION")); ?><span class="caret"></span></a>
	                        <ul class="dropdown-menu" role="menu">
	                            <li><a href="#"><?php echo (L("NATION_ZANG")); ?></a></li>
	                            <li class="divider"></li>
	                            <li><a href="#"><?php echo (L("NATION_HUI")); ?></a></li>
	                            <li class="divider"></li>
	                            <li><a href="#"><?php echo (L("NATION_MENG")); ?></a></li>
	                            <li class="divider"></li>
	                            <li><a href="#"><?php echo (L("NATION_WEI")); ?></a></li>
	                        </ul>
	                    </li>
	                </ul>
	                <ul class="nav navbar-nav navbar-right">
	                    <li><a href="#"><span class="glyphicon glyphicon-user"></span><?php echo (L("REGISTER")); ?></a></li> 
	                    <li><a href="#"><span class="glyphicon glyphicon-log-in"></span><?php echo (L("LOGIN")); ?></a></li> 
	                </ul>
	            </div>
	        </div>
	    </nav><br><br>
